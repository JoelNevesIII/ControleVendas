...
public class telaTroco extends javax.swing.JFrame {
    ...
    public telaTroco() {
        ...
        while(rs.next()){
            nota = Integer.parseInt(rs.getString(1));
        }
            
        stmt = con.prepareStatement("select valor_total from nota where id_nota = " + nota);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtValorPago, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void btnFinalizarVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinalizarVendaActionPerformed
        int troco = (Integer.parseInt(txtValorPago.getText()) - (Integer.parseInt(txtValorTotal.getText())));
        model.modelNota nota = new modelNota();
        if(troco > 0){
            CaixaDeDialogo.obterinstancia().exibirMensagem("Troco: R$ " + troco);
        ...
        if(troco == 0){
            CaixaDeDialogo.obterinstancia().exibirMensagem("Total do valor Pago");
            controller.controllerNota controller = new controllerNota();
            boolean cadastraNota = controller.CadastraNota(nota);
            dispose();
            telaRealizarVenda telaRealizarVenda = new telaRealizarVenda();
        ...
        if(troco < 0){
            CaixaDeDialogo.obterinstancia().exibirMensagem("Falta: R$ " + troco);          
        }
