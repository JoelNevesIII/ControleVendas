...
public class telaRelatorios extends javax.swing.JFrame {
    ...
    private void btnTesteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTesteActionPerformed
        try{
            String wSelect = " SELECT nome\n" +
                             "FROM cidade ";
            
            controllerRelatorio objRelController = new controllerRelatorio();
            ...
            JasperPrint jpPrint = JasperFillManager.fillReport("ireport/teste.jasper", new HashMap(), relResult);//Prepara o relatório para ser impresso, recebe o gerenciador JASPER
