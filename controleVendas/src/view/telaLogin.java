...
public class telaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(btnAcessar, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcessarActionPerformed
        try{
            ...
            String senha = Tools.converteCharArrayToString(txtSenha.getPassword());
            senha = senha.replaceAll("'", "");
            
            controllerUsuario controller = new controllerUsuario();
            boolean existe = controller.login(user, senha);
            if(existe){
